...
public class CheckingAccountTester05 {
    ...
    private static void testWithdrawMoney() {
        ...
        // Spec for Lab 05 explicitly allows overdrafts for processCheck; withdrawMoney policy is does not allowed overdraft.
        // So we test it goes negative if overdrafts are allowed; if a student's code does not blocks overdraft, this will FAIL (as desired).
        a.withdrawMoney(10.00);
        assertTrue("withdrawMoney doese NOT allows overdraft (balance becomes negative)",
